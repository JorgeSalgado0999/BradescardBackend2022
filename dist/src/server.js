...
const partnerQuestions_routes_1 = __importDefault(require("./routes/partnerQuestions.routes"));
class Server {
    constructor() {
    ...
    routes() {
        ...
        this.app.use(this.apiPaths.questionPartner, partnerQuestions_routes_1.default);
    }
    listen() {
